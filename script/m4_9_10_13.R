...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/4/data_DL_9_10_13.csv")
...
m4_9_10_13 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_9_10_13", hidden = c(300:400),
...
p4 = h2o.predict(m4_9_10_13, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_9_10_13.csv", row.names=FALSE, quote =FALSE)
