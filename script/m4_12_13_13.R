...
predict = h2o.importFile("/home/wanghl/jd_contest/0519/1/predict_DL_0_1_1.csv")
predict[,factorList] = as.factor(predict[,factorList])
predict[,modelId] = as.factor(predict[,modelId])

data <- h2o.importFile("/home/wanghl/jd_contest/0519/1/data_DL_12_13_13.csv")
...
m4_12_13_13 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_12_13_13", hidden = c(300:400),
...
p4 = h2o.predict(m4_12_13_13, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_12_13_13.csv", row.names=FALSE, quote =FALSE)
