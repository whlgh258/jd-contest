...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/1/data_DL_10_11_11.csv")
...
m4_10_11_11 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_10_11_11", hidden = c(300:400),
...
p4 = h2o.predict(m4_10_11_11, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_10_11_11.csv", row.names=FALSE, quote =FALSE)
