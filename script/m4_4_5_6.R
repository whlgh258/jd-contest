...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/2/data_DL_4_5_6.csv")
...
m4_4_5_6 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_4_5_6", hidden = c(400,500),
...
p4 = h2o.predict(m4_4_5_6, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_4_5_6.csv", row.names=FALSE, quote =FALSE)
