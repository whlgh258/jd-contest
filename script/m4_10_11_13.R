...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/3/data_DL_10_11_13.csv")
...
m4_10_11_13 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_10_11_13", hidden = c(300:400),
...
p4 = h2o.predict(m4_10_11_13, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_10_11_13.csv", row.names=FALSE, quote =FALSE)
