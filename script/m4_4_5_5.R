...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/1/data_DL_4_5_5.csv")
...
m4_4_5_5 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_4_5_5", hidden = c(300:400),
...
p4 = h2o.predict(m4_4_5_5, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_4_5_5.csv", row.names=FALSE, quote =FALSE)
