...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/2/data_DL_3_4_5.csv")
...
m4_3_4_5 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_3_4_5", hidden = c(300:400),
...
p4 = h2o.predict(m4_3_4_5, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_3_4_5.csv", row.names=FALSE, quote =FALSE)
