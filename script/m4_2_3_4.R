...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/2/data_DL_2_3_4.csv")
...
m4_2_3_4 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_2_3_4", hidden = c(400,500),
...
p4 = h2o.predict(m4_2_3_4, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_2_3_4.csv", row.names=FALSE, quote =FALSE)
