...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/4/data_DL_1_2_5.csv")
...
m4_1_2_5 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_1_2_5", hidden = c(400,500),
...
p4 = h2o.predict(m4_1_2_5, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_1_2_5.csv", row.names=FALSE, quote =FALSE)
