...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/4/data_DL_5_6_9.csv")
...
m4_5_6_9 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_5_6_9", hidden = c(300:400),
...
p4 = h2o.predict(m4_5_6_9, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_5_6_9.csv", row.names=FALSE, quote =FALSE)
