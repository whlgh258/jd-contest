...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/1/data_DL_13_14_14.csv")
...
m4_13_14_14 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_13_14_14", hidden = c(400,500),
...
p4 = h2o.predict(m4_13_14_14, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_13_14_14.csv", row.names=FALSE, quote =FALSE)
