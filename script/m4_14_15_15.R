...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/1/data_DL_14_15_15.csv")
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_14_15_15.csv", row.names=FALSE, quote =FALSE)
