...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/3/data_DL_8_9_11.csv")
...
m4_8_9_11 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_8_9_11", hidden = c(400,500),
...
p4 = h2o.predict(m4_8_9_11, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_8_9_11.csv", row.names=FALSE, quote =FALSE)
