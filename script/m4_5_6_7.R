...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/2/data_DL_5_6_7.csv")
...
m4_5_6_7 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_5_6_7", hidden = c(300:400),
...
p4 = h2o.predict(m4_5_6_7, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_5_6_7.csv", row.names=FALSE, quote =FALSE)
