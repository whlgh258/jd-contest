...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/3/data_DL_11_12_14.csv")
...
m4_11_12_14 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_11_12_14", hidden = c(300:400),
...
p4 = h2o.predict(m4_11_12_14, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_11_12_14.csv", row.names=FALSE, quote =FALSE)
