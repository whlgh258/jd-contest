...
data <- h2o.importFile("/home/wanghl/jd_contest/0519/4/data_DL_8_9_12.csv")
...
m4_8_9_12 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_8_9_12", hidden = c(300:400),
...
p4 = h2o.predict(m4_8_9_12, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_8_9_12.csv", row.names=FALSE, quote =FALSE)
