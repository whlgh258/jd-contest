...
predict = h2o.importFile("/home/wanghl/jd_contest/0519/2/predict_DL_0_1_2.csv")
predict[,factorList] = as.factor(predict[,factorList])
predict[,modelId] = as.factor(predict[,modelId])


data <- h2o.importFile("/home/wanghl/jd_contest/0519/2/data_DL_10_11_12.csv")
...
m4_10_11_12 <- h2o.deeplearning(x, y, train, nfolds=5,
  model_id = "m4_10_11_12", hidden = c(400,500),
...
p4 = h2o.predict(m4_10_11_12, predict)
...
write.csv(result4, file = "/home/wanghl/jd_contest/0519/result/result_10_11_12.csv", row.names=FALSE, quote =FALSE)
