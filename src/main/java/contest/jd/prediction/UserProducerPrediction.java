 ...
 * 2012-11-27
 */
public class UserProducerPrediction implements Runnable
{
	private static final Logger log = Logger.getLogger( UserProducerPrediction.class );
	
	private BlockingQueue<Integer> userQueue;
	private List<Integer> userIds;

	public UserProducerPrediction(BlockingQueue<Integer> userQueue, List<Integer> userIds)
	{
