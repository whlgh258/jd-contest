...
public class Popular {
    ...
    public static Map<String, Map<String, Double>> userPopular(String tablename, int labelPeriod, int actionPeriod, String mapKey){
        ...
        return popular(sql, "user_id", labelPeriod, actionPeriod, mapKey);
    }

    public static Map<String, Map<String, Double>> itemPopular(String tablename, int labelPeriod, int actionPeriod, String mapKey){
        ...
        return popular(sql, "sku_id", labelPeriod, actionPeriod, mapKey);
    }

    public static Map<String, Map<String, Double>> itemActionUserCount(String tablename, int labelPeriod, int actionPeriod, String mapKey){
    ...
    private static Map<String, Map<String, Double>> popular(String sql, String key, int labelPeriod, int actionPeriod, String mapKey){
        ...
        for(Map<String, Object> row : result){
            ...
            map.put(mapKey + labelPeriod + "_" + actionPeriod, popular);
            retMap.put(id, map);
        }
